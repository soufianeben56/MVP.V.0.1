...
class ExperimentsDetailView3 extends StatelessWidget {
  final MeasurementGraphArguments arguments;

  const ExperimentsDetailView3({super.key, required this.arguments});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: SizeConfig.relativeHeight(0.99)),
                descriptionText(strSicherheitshinweise3),
                ...
                SizedBox(height: SizeConfig.relativeHeight(0.99)),
                descriptionText(strFragenZurUntersuchung3),
              ],
            ),
          ),
        ],
  ...
  Widget _buildMaterialsWithLinks() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("R1 : 1 kΩ (Festwiderstand)", style: textStyle),
        SizedBox(height: 4),
        Text("R1 & R2: je 1kΩ (Festwiderstände)", style: textStyle),
        SizedBox(height: 4),
        Text("R4: unbekannter Widerstand (zu bestimmen)", style: textStyle),
        SizedBox(height: 4),
        Wrap(
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            TermLinkWidget(
              term: "VR1 Potentiometer",
              sectionId: HowToUseSections.potentiometer,
              style: textStyle,
            ),
            Text(" (veränderbarer Widerstand)", style: textStyle),
          ],
        ),
        SizedBox(height: 4),
        Wrap(
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            Text("Spannungsquelle 3.3 V über ", style: textStyle),
            TermLinkWidget(
              term: "Messboard-Reihe 55",
        ...
        Wrap(
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            Text("Messleitungen: ", style: textStyle),
            TermLinkWidget(
    ...
    return Column(
      ...
      children: [
        Wrap(
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            Text("1. Bauen Sie die Wheatstone-Brücke mit den vier Widerständen auf dem ", style: textStyle),
            TermLinkWidget(
              term: "Breadboard",
              sectionId: HowToUseSections.breadboards,
              style: textStyle,
            ),
            Text(" auf.", style: textStyle),
          ],
        ),
        SizedBox(height: 8),
        Wrap(
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            Text("2. Verbinden Sie ", style: textStyle),
            TermLinkWidget(
              term: "CH0 (Messboard-Reihe 1)",
              sectionId: HowToUseSections.messboard,
              style: textStyle,
            ...
            Text(", um die Spannung zwischen den Punkten A und B der Brücke zu messen", style: textStyle),
          ],
        ),
        SizedBox(height: 8),
        Text("3. Verwenden Sie die Infinity Circuit App, um den unbekannten Widerstand zu berechnen.", style: textStyle),
      ],
    );
  }
}
